...
- `@thaitype-com/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@thaitype-com/database`: [Prisma ORM](https://prisma.io/) to manage & access your database
- `@thaitype-com/typescript-config`: `tsconfig.json`s used throughout the monorepo
